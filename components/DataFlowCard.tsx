...
export const DataFlowCard: React.FC<DataFlowCardProps> = ({
    ...
    const handleMouseMove = useCallback((e: React.MouseEvent<HTMLDivElement>) => {
        ...
        el.style.transform = `perspective(1000px) rotateX(${-yPct * 8}deg) rotateY(${xPct * 8}deg)`;
    }, []);
    ...
    return (
        ...
        >
            <div className="relative group w-full max-w-sm" ref={cardRef} style={{ transition: 'transform 0.3s ease', transformStyle: 'preserve-3d', willChange: 'transform' }}>
                {/* SVG Pathway - Above */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-full w-full h-24 md:h-32 z-0 pointer-events-none">
                    <svg width="100%" height="100%" viewBox="0 0 200 100" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                        ...
                        <path d="M85 0V40L95 70V100" stroke="url(#pulse-above-1)" strokeWidth="2" strokeLinecap="round" className="animate-pulse-flow" />
                        <path d="M115 0V40L105 70V100" stroke="url(#pulse-above-2)" strokeWidth="2" strokeLinecap="round" className="animate-pulse-flow" />
                        <defs>
